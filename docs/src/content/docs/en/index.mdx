...
hero:
  ...
  actions:
    - text: Quick Start
      ...
      icon: right-arrow
    - text: GitHub
      link: https://github.com/LiStudioorg/li-gh-proxy
      icon: external
      variant: minimal
---
...
<CardGrid stagger>
  ...
  <Card title="GitHub Acceleration" icon="document">
    Prefix the full original URL with your li-gh-proxy host to accelerate Release, Raw, Clone, API, and Hugging Face downloads.
  </Card>
