...
description: Configure li-gh-proxy as a registry mirror for K3s, RKE2, and containerd.
---
...
- li-gh-proxy pulls upstream anonymously — **private authenticated images cannot be proxied**
