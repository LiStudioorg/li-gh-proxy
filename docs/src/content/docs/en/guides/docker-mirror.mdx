---
title: Docker Mirror
description: Configure Docker clients to pull images through li-gh-proxy.
---

li-gh-proxy implements Docker Registry API v2 and can accelerate Docker Hub and multiple third-party registries.
...
- Anonymous upstream pulls — **private authenticated images cannot be pulled through li-gh-proxy**
