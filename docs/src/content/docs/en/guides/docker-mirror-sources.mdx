...
description: Configure upstream registry mappings in li-gh-proxy.
---

li-gh-proxy uses the `[registries]` section for third-party registry upstreams and auth endpoints. Docker Hub always proxies to `registry-1.docker.io` and is not configured here.
