...
description: Accelerate Hugging Face model and LFS downloads through li-gh-proxy.
---

Hugging Face uses the same URL-prefix proxy as GitHub — prepend your li-gh-proxy host to the **full original URL**.
