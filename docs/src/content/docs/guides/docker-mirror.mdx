---
title: Docker 镜像加速
description: 配置 Docker 客户端使用 li-gh-proxy 加速镜像拉取。
---

li-gh-proxy 兼容 Docker Registry API v2，可作为 Docker Hub 及多种第三方 Registry 的镜像加速入口。
...
- 当前版本对 Registry 使用匿名拉取，**无法**通过 li-gh-proxy 拉取需要认证的私有镜像
