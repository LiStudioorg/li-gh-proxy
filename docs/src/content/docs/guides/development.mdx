---
title: 二次开发与构建
description: 扩展加速域名、Registry 映射，以及从源码构建 li-gh-proxy。
---
...
# 将 dist 复制到 src/dist
cd ../src && go build -o li-gh-proxy .
```

## Docker 构建

```bash
docker build -t li-gh-proxy:local --build-arg VERSION=1.0.0 .

docker buildx build --platform linux/amd64,linux/arm64 \
  -t ghcr.io/your-org/li-gh-proxy:latest \
